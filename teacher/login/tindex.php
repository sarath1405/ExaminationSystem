...
<body>
    <div class="header">
        ...
        <span>
            <ul class="nav">
                ...
                <li><a href="/student/login/sindex.php"><span>Student</span></a></li>
    ...
    <form action="/teacher/login/tlogin.php" method="post" class="form" autocomplete="off" target="_self">
    ...
    <div class="register">
        <p><i>New Teacher?</i><a href="/teacher/register/trindex.php"><button>Register</button></a></p>
    </div>
</body>
</html>