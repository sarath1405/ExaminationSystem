...
<body>
    <div class="header">
        ...
        <span>
            <ul class="nav">
                ...
                <li><a href="/student/login/sindex.php">Student</a></li>
                <li class="stud"><a href="/teacher/login/tindex.php">Teacher</a></li>
                <li><a href="https://github.com/sarath1405/OnlineExamination"><i class="fa fa-github"></i>  GitHub</a></li> 
            </ul>
        </span>
    </div>
    <form action="/teacher/register/trlogin.php" method="post" class="form" autocomplete="off">
    ...
    <div class="register">
        <p><i>Already registered?</i><a href="/teacher/login/tindex.php"><button>Login</button></a></p>
    </div>
</body>
</html>