...
<body>
    <div class="header">
        ...
        <span>
            <ul class="nav">
                ...
                <li><a href="/ExaminationSystem/student/login/sindex.php">Student</a></li>
                <li class="stud"><a href="/ExaminationSystem/teacher/login/tindex.php">Teacher</a></li>
                <li><a href="https://github.com/sarath1405/OnlineExamination"><i class="fa fa-github"></i>  GitHub</a></li> 
            </ul>
        </span>
    </div>
    <form action="/ExaminationSystem/teacher/register/trlogin.php" method="post" class="form" autocomplete="off">
        <h2 class="formHeader">TEACHER REGISTRATION</h2>
        <div class="details">
            <?php
            if(isset($_GET['error'])) { ?>
    ...
    <div class="register">
        <p><i>Already registered?</i><a href="/ExaminationSystem/teacher/login/tindex.php"><button>Login</button></a></p>
    </div>
</body>
</html>