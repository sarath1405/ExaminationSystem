...
<body>
    ...
    <form action="/student/login/slogin.php" method="post" class="form" autocomplete="off" target="_self">
    ...
    <div class="register">
        <p><i>New Student?</i><a href="/student/register/rindex.php"><button>Register</button></a></p>
    </div>
</body>
</html>